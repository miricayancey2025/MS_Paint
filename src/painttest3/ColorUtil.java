 ...
 *
 * @author miric
 * Sets a color name string to a given color value to be displayed
 */
...
public class ColorUtil {
     ...
     *
     * @param hexColor the int hex color you are deriving a name from
     * @return the colorName gotten from RBG
     */
     ...
     *
     * @param c the color you are converting to hex
     * @return hex code
     */
    ...
    /**
     * gets the color name from the RGB value
     *
     * @param color the color you're getting the name from
     * @return Color Name
     */
    ...
    public class ColorName {
        ...
        /**
         *
         * @param pixR red value
         * @param pixG green value
         * @param pixB blue value
         * @return MSE
         */
